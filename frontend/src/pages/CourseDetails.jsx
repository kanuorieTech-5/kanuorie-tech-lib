  ...
  useEffect(() => {
    async function loadCourse() {
      try {
        ...
        setRelatedCourses(
          (coursesRes.data || []).filter((item) => item._id !== id).slice(0, 3),
        );
      } catch (error) {
        console.error(error);
      } finally {
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            {(course.learningOutcomes?.length
              ...
              <Card key={index} className="flex items-start gap-4">
                <CheckCircle2 className="mt-1 text-green-500" size={22} />
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <Card className="mt-16 flex flex-col gap-8 lg:flex-row lg:items-center">
            <img
              src={
                course.instructorImage || "/images/instructor-placeholder.jpg"
              }
      ...
      <section className="py-24">
        <div className="mx-auto max-w-5xl px-6">
          <Card className="text-center">
            ...
            <h2 className="mt-8 text-4xl font-black">Earn Your Certificate</h2>

            <p className="mx-auto mt-6 max-w-2xl leading-8 text-slate-600">
              Complete every lesson and pass the course assessments to receive
              ...
              {relatedCourses.map((item) => (
                <Card key={item._id} hover className="overflow-hidden p-0">
                  ...
                  <div className="p-6">
                    ...
                    <Link to={`/courses/${item._id}`} className="mt-6 block">
                      <Button fullWidth>
                        View Course
