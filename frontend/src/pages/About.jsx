    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 py-28 text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center lg:px-8">
          ...
          >
            Building Technology.
            <span className="block text-blue-400">Creating Opportunities.</span>
            Empowering People.
          </motion.h1>
          ...
          >
            KanuorieTech is a technology-driven digital ecosystem focused on
            building practical digital solutions, providing technology services,
            creating educational resources, and helping individuals and
            organizations grow through technology.
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-400">
              A growing technology ecosystem built around innovation, education,
              digital solutions, creativity, and meaningful impact.
            </p>
          </div>
          ...
          <article className="space-y-10 text-lg leading-9 text-slate-900">
            <p>
              KanuorieTech was created with a simple but powerful vision: to
              make technology more accessible, practical, useful, and impactful
              for individuals, learners, entrepreneurs, businesses, and
              organizations. Technology continues to transform the way people
              communicate, learn, work, build businesses, access information,
              and solve problems. However, having access to technology does not
              automatically mean having the knowledge or resources required to
              use it effectively. KanuorieTech exists to help bridge that gap by
              combining technology, education, digital services, creativity, and
              practical solutions within one growing digital ecosystem.
            </p>

            <p>
              At its core, KanuorieTech is a technology and digital innovation
              company that develops and provides solutions designed around real
              user needs. Our approach is centered on identifying problems,
              understanding the people affected by those problems, and using
              technology to create solutions that are practical, scalable,
              accessible, and easy to use. Rather than building technology
              simply because it is possible, we focus on building products and
              services that have a clear purpose and provide meaningful value to
              users.
            </p>

            <p>
              One of the important areas of KanuorieTech is software and web
              development. We design and develop modern digital experiences for
              businesses, organizations, entrepreneurs, communities, and
              individuals. Our development approach focuses on creating
              responsive, intuitive, secure, and user-friendly applications that
              work effectively across different devices and screen sizes. From
              business websites and landing pages to interactive web
              applications, dashboards, e-commerce platforms, learning systems,
              and other custom digital solutions, KanuorieTech approaches every
              project with attention to functionality, usability, performance,
            ...
            <p>
              ...
              infrastructure, useful content, strategic thinking, and continuous
              improvement. For this reason, our services extend beyond writing
              code. We aim to support clients and users throughout their digital
              journey by helping them transform ideas into functional digital
              products and by providing the resources and knowledge required to
              operate and grow those products effectively.
            </p>
            ...
            <p>
              ...
              improve their skills. KanuorieTech is therefore designed to serve
              not only as a technology company but also as a learning platform.
              Through courses, tutorials, books, notes, guides, educational
              resources, and practical learning materials, the platform aims to
              make knowledge more accessible to people at different stages of
            ...
            <p>
              ...
              definitions or watching tutorials without applying the knowledge.
              Learners should have opportunities to understand concepts,
              practice what they have learned, build projects, solve problems,
              make mistakes, debug their work, and gradually develop the
              confidence required to use their skills in real-world situations.
              KanuorieTech therefore aims to encourage project-based learning
              and continuous experimentation as important parts of the learning
              experience.
            </p>
            ...
            <p>
              ...
              requiring users to search through multiple disconnected sources,
              the platform can provide access to books, notes, guides, courses,
              tutorials, and other digital resources through an organized
              system. This structure makes it easier for users to discover
              information, continue learning, and build their personal knowledge
              base over time.
            </p>

            <p>
              KanuorieTech also places importance on digital products. Digital
              products can provide individuals and businesses with practical
              tools that save time, improve productivity, organize information,
              simplify repetitive tasks, or support professional development.
              Through its digital product ecosystem, KanuorieTech aims to create
              and provide useful resources such as templates, educational
              materials, digital tools, guides, and other technology-driven
              products that can provide immediate and long-term value to users.
            </p>
            ...
            <p>
              ...
              idea, an experiment, or an opportunity to learn something new. Our
              project ecosystem allows us to showcase digital solutions that
              demonstrate our capabilities, creativity, technical growth, and
            ...
            <p>
              ...
              powerful when people are able to share knowledge, exchange ideas,
              ask questions, collaborate on projects, and learn from one
              another. KanuorieTech is therefore being developed with community
              and user engagement in mind. Our goal is to create an environment
              where learners, developers, entrepreneurs, professionals,
              creators, and technology enthusiasts can discover useful
              information, access resources, develop skills, and explore
              opportunities.
            </p>

            <p>
              Security and responsible technology development are also important
              principles behind the KanuorieTech platform. Modern digital
              applications handle information that users expect to remain
              protected. For this reason, authentication, authorization, data
              protection, secure communication, controlled access, and
              responsible handling of user information are considered important
              parts of the platform's development process. As the platform
              continues to evolve, security remains an area that requires
              continuous attention, improvement, and adaptation to emerging
            ...
            <p>
              ...
              remains static can quickly become outdated. We therefore approach
              development as an ongoing process rather than a one-time activity.
              New features, improvements, resources, services, products, and
              learning opportunities can continue to be introduced as user needs
              evolve and new technologies become available.
            </p>
            ...
            <p>
              Our long-term objective is to build technology that creates value
              beyond the screen. A successful digital solution should not simply
              look good; it should solve a problem, improve an experience, save
              time, provide knowledge, create opportunities, or make something
              easier. This principle influences how we think about products,
              services, educational resources, and software development at
              KanuorieTech.
            </p>

            <p>
              As KanuorieTech continues to grow, our commitment remains focused
              on learning, innovation, accessibility, quality, and meaningful
              impact. We understand that building a technology company is a
              continuous journey that requires experimentation, resilience,
              adaptation, and an openness to learning from both successes and
              failures. Every project, feature, resource, and interaction
              contributes to that journey and provides an opportunity to improve
              what comes next.
            </p>
            ...
            <p>
              ...
              services, project development, or community-driven learning, our
              goal is to contribute to a more digitally capable and empowered
              generation. We are building not just individual products, but an
              ecosystem where people can learn, create, connect, solve problems,
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-6 leading-8 text-slate-400">
                ...
                practical digital solutions to help individuals, entrepreneurs,
                businesses, and organizations solve problems, develop skills,
                improve their digital capabilities, and create meaningful
                opportunities.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-6 leading-8 text-slate-600">
                ...
                innovation work together to create opportunities for people to
                learn, create, connect, solve problems, and grow.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600">
                ...
                creating an environment where people can continuously learn and
                grow.
              </p>
            </div>

            <div className="rounded-3xl bg-slate-950 p-8 text-white md:p-10">
              <h3 className="text-2xl font-bold">Our Long-Term Focus</h3>
              ...
              <div className="mt-8 space-y-5">
                {futureGoals.map((goal) => (
                  <div key={goal} className="flex items-start gap-4">
                    ...
                    <span className="leading-7 text-slate-300">{goal}</span>
                  </div>
                ))}
              </div>
            </div>
