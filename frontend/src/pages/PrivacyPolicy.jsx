        ...
        <div className="space-y-12 text-base leading-8 text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              ...
              <li>Communicate with users regarding their accounts</li>
              <li>Send requested newsletters and updates</li>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">
              5. Educational and Platform Activity
            </h2>
          ...
          <section className="border-t border-slate-200 pt-10 dark:border-slate-800">
            ...
            <p className="mt-4">
              We will make reasonable efforts to review and respond to
              legitimate privacy-related requests within an appropriate
              timeframe.
            </p>
          </section>
