      ...
      <div className="relative mx-auto grid items-center gap-16 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-slate-300">
            Explore premium books, guides, documentation and learning
            resources carefully curated to help you become a better
            software developer.
          </p>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl sm:col-span-2">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              Frontend, Backend, DevOps, UI/UX, AI, System Design,
              Interview Preparation and much more—all in one place.
            </p>
